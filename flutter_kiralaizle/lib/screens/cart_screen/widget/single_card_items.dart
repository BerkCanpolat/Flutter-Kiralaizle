                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: CupertinoButton(
                        padding: EdgeInsets.zero,
                        onPressed: () {
                          if(!appProvider.getFavouritedProductList
                                .contains(widget.cartProduct)){
                            appProvider.addFavouriteProduct(widget.cartProduct);
                          }else{
                            appProvider.removeFavouriteProduct(widget.cartProduct);
                          }
                        },
                        child: Text(appProvider.getFavouritedProductList
                                .contains(widget.cartProduct)
                            ? "Removed to wishlist"
                            : "Add to wishlist"
                            ),
