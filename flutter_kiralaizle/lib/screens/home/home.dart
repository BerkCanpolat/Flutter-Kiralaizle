  ...
  Widget build(BuildContext context) {
    return Scaffold(
        body: SingleChildScrollView(
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 25,),
                Text("Kategoriler",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18),),
              ],
            ),
          ),
          ...
          Padding(
            padding: GeneralPadding.instace.generalPadding.padding,
            child: Text("En İyi Filmler",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18),),
          ),
          GridView.builder(
            shrinkWrap: true,
            primary: false,
