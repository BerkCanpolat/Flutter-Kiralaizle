    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          TextFormField(controller: name,decoration: InputDecoration(hintText: appProvider.getuserInformationProvider.name),),
          ElevatedButton(onPressed: (){
            UserModel model = appProvider.getuserInformationProvider.copyWith(name: name.text);
            appProvider.kullaniciyiGuncelle(image, model, context);
          }, child: Text("Güncelle")),
        ],
      )
    );
